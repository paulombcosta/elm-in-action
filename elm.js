...
var _user$project$PhotoFolders$finishPhoto = function (_p0) {
	...
	return {
		ctor: '_Tuple2',
		_0: _p3,
		_1: {url: _p3, size: _p2.size, title: _p2.title, relatedUrls: _p2.relatedUrls}
	};
};
var _user$project$PhotoFolders$fromPairs = function (pairs) {
	return _elm_lang$core$Dict$fromList(
		A2(_elm_lang$core$List$map, _user$project$PhotoFolders$finishPhoto, pairs));
};
...
var _user$project$PhotoFolders$JsonPhoto = F3(
	function (a, b, c) {
		return {title: a, size: b, relatedUrls: c};
	});
var _user$project$PhotoFolders$jsonPhotoDecoder = A3(
	...
	A3(
		...
		A3(
			...
			'title',
			_elm_lang$core$Json_Decode$string,
			_elm_lang$core$Json_Decode$succeed(_user$project$PhotoFolders$JsonPhoto))));
var _user$project$PhotoFolders$photosDecoder = A2(
	_elm_lang$core$Json_Decode$map,
